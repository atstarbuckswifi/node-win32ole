...
win32ole.OLEException = function(code, msg)
{
  this.name = 'OLEException';
  this.code = code;
  if(msg)
  {
    this.message = msg;
  } else {
    this.message = '00000000' + code.toString(16);
    this.message = 'Error ' + this.message.substr(this.message.length-8);
  }
  Error.captureStackTrace(this, this.constructor);
}
subclass(win32ole.OLEException, Error)
